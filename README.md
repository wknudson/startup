...
- [x] **Backend listens for WebSocket connection** - Securing Websocket endpoints and welcoming user.
- [x] **Frontend makes WebSocket connection** - Recieving Websocket updates from the server.
- [x] **Data sent over WebSocket connection** - Broadcasting ride readiness.
- [x] **WebSocket data displayed** - Welcome message and ride readiness.
- [x] **Application is fully functional** - Correct.
